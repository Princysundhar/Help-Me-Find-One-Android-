...
import com.example.helpme.databinding.ActivityViewComplaintBinding;
...
//
                                ...
                                li.setAdapter(new custom_view_complaint(getApplicationContext(),cid,complaint,complaint_date,reply,reply_date));
...
//        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_view_complaint);
