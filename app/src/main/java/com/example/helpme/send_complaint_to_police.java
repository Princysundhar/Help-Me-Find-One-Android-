...
public class send_complaint_to_police extends AppCompatActivity {
    EditText e1;
    Button b1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_complaint_to_police);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (flag ==0)
                {
                    ...
                    url = sh.getString("url", "") + "android_send_complaint_to_police";
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                            Toast.makeText(send_complaint_to_police.this, "complaint Send", Toast.LENGTH_SHORT).show();
